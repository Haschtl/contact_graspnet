...
class PandaGripper(Gripper):
    ...
    def __init__(self, q=None, root_folder=os.path.join(os.path.dirname(os.path.realpath(__file__)), "panda")):
    ...
    def __initMeshes(self,root_folder):
        ...
        fn_finger = os.path.join(
            root_folder, 'finger.stl')

        self.base = trimesh.load(fn_base)
        finger_l = trimesh.load(fn_finger)
